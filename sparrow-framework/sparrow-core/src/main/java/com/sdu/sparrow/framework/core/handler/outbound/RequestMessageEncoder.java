package com.sdu.sparrow.framework.core.handler.outbound;

import com.sdu.sparrow.framework.common.constant.RpcMessageConstant;
 ...
 * |
 * +-----------------------------------------------------------------------------------------------------------------------------------------------------
 * 4B magic(魔数)   ---> RpcClient.getBytes()
 * 1B version(版本) ---> 1
