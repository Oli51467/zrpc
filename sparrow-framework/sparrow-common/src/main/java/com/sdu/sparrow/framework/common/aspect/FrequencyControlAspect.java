package com.sdu.sparrow.framework.common.aspect;

import cn.hutool.core.util.StrUtil;
import com.sdu.sparrow.framework.common.annotation.FrequencyControl;
import com.sdu.sparrow.framework.common.entity.holder.UserContextHolder;
import com.sdu.sparrow.framework.common.frequency.FrequencyControlDTO;
import com.sdu.sparrow.framework.common.frequency.FrequencyControlUtil;
import com.sdu.sparrow.framework.common.util.SpElUtil;
...
import static com.sdu.sparrow.framework.common.constant.Constants.TOTAL_COUNT_WITH_IN_FIX_TIME_FREQUENCY_CONTROLLER;
...
public class FrequencyControlAspect {
    ...
    @Around("@annotation(com.sdu.sparrow.framework.common.annotation.FrequencyControl)||@annotation(com.sdu.sparrow.framework.common.annotation.FrequencyControlContainer)")
