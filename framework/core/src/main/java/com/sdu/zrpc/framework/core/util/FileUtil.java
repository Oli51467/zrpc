package com.sdu.zrpc.framework.core.util;
...
public class FileUtil {
    ...
    public static List<Class<?>> filterClassWithServiceAnnotation(List<String> classNames) {
        return classNames.stream()
                ...
                .filter(clazz -> clazz.getAnnotation(ZrpcService.class) != null)
    ...
    public static List<ServiceConfig> createServiceConfigWithClasses(List<Class<?>> classes) {
        ...
        for (Class<?> clazz : classes) {
            ...
            ZrpcService zrpcService = clazz.getAnnotation(ZrpcService.class);
            String application = zrpcService.application();
