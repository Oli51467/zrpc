...
@Slf4j
public class ErrorResponseStrategy extends AbstractRpcResponseStrategy implements RpcResponseStrategy {
    ...
    public void complete(RpcResponse response, SocketAddress socketAddress) {
        ...
        completableFuture.complete(JSONObject.toJSONString(ResponseResult.invokeError(requestId, responseCode)));
