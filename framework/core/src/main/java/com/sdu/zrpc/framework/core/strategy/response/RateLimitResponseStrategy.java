...
@Slf4j
public class RateLimitResponseStrategy extends AbstractRpcResponseStrategy implements RpcResponseStrategy {
    ...
    public void complete(RpcResponse response, SocketAddress socketAddress) {
        ...
        completableFuture.complete(JSONObject.toJSONString(ResponseResult.invokeLimited(requestId, responseCode)));
