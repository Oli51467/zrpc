package com.sdu.irpc.framework.common.frequency;

import com.sdu.irpc.framework.common.util.RedisUtil;
...
@Slf4j
@Service
public class FixedRateFrequencyControlService extends AbstractFrequencyControlService<FrequencyControlDTO> {
