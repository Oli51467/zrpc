package com.sdu.arrow.framework.core.listener;
...
@Component
@Slf4j
public class EnableArrowListener implements ApplicationListener<ApplicationReadyEvent> {

    @SneakyThrows
    @Override
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ApplicationContext applicationContext = event.getApplicationContext();
        // 获取所有带有 @EnableArrow 注解的 bean
        Map<String, Object> beansWithAnnotation = applicationContext.getBeansWithAnnotation(EnableArrow.class);
        for (Object bean : beansWithAnnotation.values()) {
            ...
            // 获取类上的 @EnableArrow 注解
            EnableArrow annotation = clazz.getAnnotation(EnableArrow.class);
            if (null == annotation) {
                continue;
            }
